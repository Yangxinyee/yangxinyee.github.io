const translations = {
    en: {
        meta: {
            title: "Charlie Yang | Software Development Engineer at AWS Kiro",
            description: "Charlie Yang is a Software Development Engineer at AWS Kiro building agentic AI developer experiences."
        },
        ...
        hero: {
            eyebrow: "Software Development Engineer at AWS Kiro",
        ...
        experience: {
            kicker: "Experience", title: "Where I’ve built and learned.", intro: "From production AI developer tools to medical imaging systems.", current: "Current", earlier: "Earlier experience",
            "aws-kiro": { title: "Software Development Engineer", company: "Amazon Web Services · Kiro", date: "Jun 2026 – Present", location: "Seattle, WA", summary: "Building agentic AI developer experiences and evolving the context systems that make long-running workflows more capable, reliable, and intuitive." },
            "aws-kiro-intern": { title: "Software Development Engineer Intern", company: "Amazon Web Services · Kiro", date: "Jun 2025 – Aug 2025", location: "Seattle, WA", summary: "Led the design and productization of a modular context management system combining hierarchical compaction, memory, and retrieval." },
            "brown-health": { title: "Research Intern", company: "Brown University Health", date: "Mar 2025 – Present", location: "Providence, RI", summary: "Developed an AI-powered medical imaging platform for report generation, image analysis, and clinical comparison workflows." },
    ...
    zh: {
        meta: {
            title: "杨新烨 | AWS Kiro 软件开发工程师",
            description: "杨新烨是 AWS Kiro 软件开发工程师，专注于智能代理 AI 与开发者工具。"
        },
        nav: { home: "首页", about: "关于", experience: "经历", education: "教育", skills: "技能", contact: "联系" },
        common: { skip: "跳转到正文", details: "查看详情" },
        hero: {
            eyebrow: "AWS Kiro 软件开发工程师",
        ...
        experience: {
            kicker: "工作经历", title: "我构建产品与积累经验的地方。", intro: "从生产级 AI 开发者工具到医疗影像系统。", current: "目前", earlier: "更早经历",
            "aws-kiro": { title: "软件开发工程师", company: "亚马逊云服务 · Kiro", date: "2026年6月 – 至今", location: "华盛顿州西雅图", summary: "构建智能代理 AI 开发者体验，并持续演进上下文系统，让长周期任务更强大、更可靠、更易用。" },
            ...
            "brown-health": { title: "研究实习生", company: "布朗大学健康中心", date: "2025年3月 – 至今", location: "罗德岛州普罗维登斯", summary: "开发面向医疗报告生成、影像分析与临床对比工作流的 AI 医学影像平台。" },
