const translations = {
    en: {
        ...
        about: {
            ...
            paragraph1a: "I’m a software engineer at AWS Kiro IDE",
            paragraph1b: ".",
            ...
            paragraph2b: ".",
            research1: "My research aims to transform the healthcare experience with AI—improving hospital triage efficiency and building trustworthy, parameter-efficient AI systems for clinical decision support. Recently, I have been exploring ",
            researchTopic1: "EHR-Based Patient World Models",
            researchAnd: " and ",
            researchTopic2: "Loop World Models",
            researchMid: ", and developing reliable ",
            researchTopic3: "Medical Agent Systems",
            researchEnd: " along with large-scale data processing infrastructure for training medical world models (",
            research2: ").",
            advisors1a: "At CU Anschutz",
            advisors1b: ", I’m advised by",
            advisors2a: ". At Brown",
            advisors2b: ", I was advised by",
            advisorsUstbA: ". At the University of Science and Technology Beijing",
            advisorsUstbB: ", I was advised by",
            ...
            highlight3: "As an intern, designed and shipped Kiro IDE's core distributed context compaction system—hierarchical compression, achieving 80–90% compression—and drove its production launch serving 100K+ users.",
        ...
        news: {
            ...
            n4: "Our paper on confidence-gated cloud–edge cascade triage for medical imaging is published in Smart Health and is selected as an Oral presentation 🏅!",
    ...
    zh: {
        ...
        about: {
            welcome: "欢迎来到我的主页！",
            paragraph1a: "我目前是 AWS Kiro IDE",
            paragraph1b: " 的软件工程师。",
            paragraph2a: "在产品工程之外，我也在科罗拉多大学安舒茨医学院",
            paragraph2b: "参与医疗影像与 AI 智能体研究。",
            research1: "我的研究方向和目标是用 AI 革新医疗体验、提高医院分诊效率，并探索可信赖、参数高效的 AI 医学辅助系统。近期我在探索 ",
            researchTopic1: "EHR 患者世界模型",
            researchAnd: "与",
            researchTopic2: "循环世界模型",
            researchMid: "，并开发可靠的",
            researchTopic3: "医学智能体系统",
            researchEnd: "，以及用于医学世界模型训练的大规模数据处理基础设施（",
            research2: "）。",
            advisors1a: "在科罗拉多大学安舒茨医学院",
            advisors1b: "，我的导师是",
            advisors2a: "。在布朗大学",
            advisors2b: "期间，我的导师是",
            advisorsUstbA: "。在北京科技大学",
            advisorsUstbB: "期间，导师为",
            ...
            highlight3: "实习期间设计并落地 Kiro IDE 核心分布式上下文压缩系统：层次化压缩，压缩率达 80–90%，并推动产品上线、服务 10 万以上用户。",
        ...
        news: {
            ...
            n4: "关于医学影像置信度门控云边级联分诊的论文发表于 Smart Health，并入选口头报告（Oral）🏅！",
            n5: "获得布朗大学计算机科学硕士学位！",
